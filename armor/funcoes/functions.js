...
const banner2 = cfonts.render(('BRUCE BOT MD'), {
font: 'block',
align: 'center',
gradrient: ["#FF8C00", "#FF4500"],
colors: ["#FF8C00", "#FF4500"],
lineHeight: 1
});
 
const banner3 = cfonts.render((`「𝕭𝖗𝖚𝖈𝖊」`), {
font: 'block',             
align: 'center',           
...
if (!packname) packname = '𝕭𝖗𝖚𝖈𝖊'; if (!author) author = '「𝕭𝖗𝖚𝖈𝖊」';	
...
chyt = `5521974836373@s.whatsapp.net`
