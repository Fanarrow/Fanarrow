...
const spinner2 = { 
  "interval": 150,
  "frames": ["CANAL : Youtube.com/C/Fanarrow"]}
...
const banner2 = cfonts.render(('Canal: youtube.com/C/Fanarrow'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`IA Do ZAP`), {
font: 'tiny',             
align: 'center',           
...
authorname = 'IA Do ZAP'
packname = '-JR-'
  
function addMetadata(packname, author) {	
if (!packname) packname = '-JR-'; if (!author) author = 'IA Do ZAP';	
